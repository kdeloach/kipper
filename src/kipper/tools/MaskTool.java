...
public class MaskTool
{
    ...
    public MaskTool()
    {
        ...
        pane2.add(txt, BorderLayout.CENTER);
        ...
        pane2.add(btn, BorderLayout.LINE_END);
...
class MaskDrawPanel extends JPanel implements MouseListener, MouseWheelListener
{
    ...
    public void paint(Graphics g)
    {
        ...
        g.drawString("MOUSE1 Add Point", 5, 15);
        g.drawString("MOUSE2 Remove last Point", 5, 30);
        g.drawString("MOUSEWHEEL Zoom in/out", 5, 45);
    }
