...
public class KirbyExplosion extends ParticleEmitterConfig
{
    ...
    @Override public float getHue(Particle p) { return 170f / 240f; }
    @Override public float getSaturation(Particle p) { return 110f / 240f; }
